...
> Today I am going to use [Hopper Disassembler](https://www.hopperapp.com/). I love hopper but ghidra will also be able to accomplish the same. Both have pseudocode options, that comes in very handy. Remember the checklist above of important information we must be looking for to orient ourselves in the decompiler view because it can get very hectic at times.
